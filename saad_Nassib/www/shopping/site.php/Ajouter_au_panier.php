...
<head>
    <title>Accueil</title>
    <link rel="stylesheet" target=_blank href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css">
    <style>
        body {
...
<body>
    ...
    <div class="row mt-4">
                <div class="col-md-12 text-center">
                    <a target=_blank href="Consulter_panier.php" class="btn btn-primary">Consulter le Panier</a>
                    <a target=_blank href="accueil_client.php" class="btn btn-secondary">Retour à l'Accueil</a>
                </div>
            </div>
        </div>
    </div>
